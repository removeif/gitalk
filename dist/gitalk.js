  ...
  (0, _createClass3.default)(GitalkComponent, [{
    ...
    value: function header() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        this.isLocked ? null : _react2.default.createElement(
          'div',
    ...
    value: function comments() {
      ...
      return _react2.default.createElement(
        ...
        !totalComments.length && _react2.default.createElement(
          ...
          this.isLocked ? null : this.i18n.t('first-comment-person')
        ),
    ...
    key: 'isLocked',
    get: function get() {
      var isLocked = this.options.isLocked;
...
var _de = __webpack_require__(157);
...
module.exports = {"init":"Gitalk 加载中 ...","no-found-related":"未找到相关的 %{link} 进行评论","please-contact":"请联系 %{user} 初始化创建","init-issue":"初始化 Issue","leave-a-comment":"说点什么","preview":"预览","edit":"编辑","comment":"评论","support-markdown":"支持 Markdown 语法","login-with-github":"使用 GitHub 登录","first-comment-person":"来做第一个留言的人吧！","commented":"发表于","load-more":"加载更多","counts":"%{counts} 条评论","sort-asc":"从旧到新排序","sort-desc":"从新到旧排序","logout":"注销","anonymous":"未登录用户","owner":"博主","has-closed":"此处评论已关，暂不支持评论。"}
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            isAdmin ? _react2.default.createElement(
              'span',
              { className: 'gt-btn gt-btn-public gt-comment-owner' },
              owner
            ) : null,
